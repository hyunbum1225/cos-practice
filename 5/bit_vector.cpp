...
int main(int argc, char *argv[])
{
    ...
    printf("Sign magnitude addition: %u\n", sign_magnitude_addition(bv1, bv2));
    printf("One's complement addition: %u\n", ones_complement_addition(bv2, bv2));
    printf("Two's complement addition: %u\n", twos_complement_addition(bv1, bv2));
    return 0;
}
...
int check_validity(char *input)
{
    ...
    // 1. the length of the input must be identical to BIT_VECTOR_LENGTHjj
    len = strlen(input);
